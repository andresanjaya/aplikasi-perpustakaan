        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p> Selamat datang, <b> <?= $_SESSION['nama_lengkap'] ?></b> anda berhasil Login sebagai Petugas. </p>
                    <!-- Content Row -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    ...
                                    <a class="nav-link collapsed" href="CRUD_SISWA/crud_siswa.php">
                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="../admin/assets/img/siswa.png" alt="...">
                                    </div>
                                    <p>Add some quality, svg illustrations to your project courtesy of </a>, a
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <a class="nav-link collapsed" href="CRUD_BUKU/crud_buku.php">
                                        <h6 class="m-0 font-weight-bold text-success "> Data Buku</h6>
                                    </a>
                                </div>
                                <div class="card-body">
                                    <div class="text-center">
                                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="../admin/assets/img/book.png" alt="...">
                                    </div>
                                    <p>Add some quality, svg illustrations to your project courtesy of </a>, a
                                        constantly updated collection of beautiful svg images that you can use
                                        completely free and without attribution!</p>
