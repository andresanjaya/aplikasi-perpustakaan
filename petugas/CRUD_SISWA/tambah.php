                        ...
                        <div class="card-body">
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="username" id="username" required autocomplete="off" class="form-control" placeholder="Input Nis/Username">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="level" id="level" class="form-control" value="siswa" readonly require>
                                </div>
