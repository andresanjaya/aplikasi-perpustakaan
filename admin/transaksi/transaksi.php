...
$transaksi = $koneksi->query("SELECT * FROM tb_transaksi WHERE status= 'pinjam' ");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Transaksi Buku</h1>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><font color='success'><?php echo $data['status']; ?> </font></td>
                                                            ...
                                                            <td>
                                                                <a href="kembali.php?id=<?php echo $data['id_transaksi']; ?>&judul=<?php echo $data['judul'] ?>" class="btn btn-danger">Kembali</a>
                                                                <a href="perpanjang.php?id=<?php echo $data['id_transaksi']; ?>&judul=<?php echo $data['judul']; ?>&tgl_kembali=<?php echo $data['tgl_kembali'] ?>&lambat=<?php echo $lambat; ?>" class="btn btn-info">Perpanjang</a>
                                                            </td>
                                                        </tr>
                                                    <?php  } ?>
                                                </tbody>
