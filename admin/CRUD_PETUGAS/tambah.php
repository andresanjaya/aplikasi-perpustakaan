                    ...
                    <div class="card mb-4 py-3 border-left-primary">
                        <div class="card-body">
                            <form action="" method="post" enctype="multipart/form-data">
                                <input type="hidden" name="id" value="<?php echo $mhs["id_petugas"]; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="username" id="username" required autocomplete="off" class="form-control" placeholder="Input Username">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_lengkap" id="nama_lengkap" required autocomplete="off" class="form-control" placeholder="Input Nama Lengkap">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="password" id="password" required autocomplete="off" class="form-control" placeholder="Input Password">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="level" id="level" class="form-control" value="petugas" readonly require>
                                </div>
