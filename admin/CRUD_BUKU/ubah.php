...
$swa = query("SELECT * FROM tb_buku WHERE id_buku = $id")[0];
          ...
          <div class="card mb-4 py-3 border-left-primary">
            <div class="card-body">
              <form action="" method="post" enctype="multipart/form-data">
                <input type="hidden" name="id" value="<?= $swa["id_buku"]; ?>">
                <input type="hidden" name="gambarLama" value="<?= $swa["cover"]; ?>">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="judul" id="judul" required value="<?= $swa["judul"]; ?>" autocomplete="off" class="form-control">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="pengarang" id="pengarang" required value="<?= $swa["pengarang"]; ?>" autocomplete="off" class="form-control">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="penerbit" name="penerbit" id="penerbit" required value="<?= $swa["penerbit"]; ?>" autocomplete="off" class="form-control">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="kode_buku" id="kode_buku" required value="<?= $swa["kode_buku"]; ?>" class="form-control">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="jumlah_buku" id="jumlah_buku" required value="<?= $swa["jumlah_buku"]; ?>" class="form-control">
                </div>

                <div class="form-group">
                  <label for="cover">
                    Cover : <br>
                    <img src="buku/<?= $swa['cover']; ?>" width="70"> <br>
                    <br>
